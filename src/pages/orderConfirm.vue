    ...
    <div class="wrapper">
      <div class="container">
        <div class="order-box">
          ...
          <div class="item-good" v-for="(item, index) in cartList" :key="index">
            <h2>商品</h2>
            <ul>
              <li>
                <div class="good-name">
...
export default {
  ...
  data() {
    return {
      ...
      showDelModal: false, //删除
      showEditModal: false, //编辑
      checkIndex: 0
    }
  },
  mounted() {
  ...
  methods: {
    ...
    delAddress(item) {
      ...
      /*  this.submitAddress(this.checkedItem, this.userAction) */
    },
    //修改地址
        ...
        .addr-list {
          ...
          .addr-add {
            ...
            .icon-add {
              ...
              height: 30px;
              border-radius: 50%;
              background: url('../../public/imgs/icon-add.png') #e0e0e0
                no-repeat center;
